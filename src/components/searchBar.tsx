...
type AutoCompleteProps = {
  ...
  emptyMessage: string
  value: Option | null;
  onValueChange?: (value: Option | null) => void; // Updated the type
  isLoading?: boolean
  disabled?: boolean
  placeholder?: string
}
...
export const AutoComplete = ({
  ...
  return (
    <CommandPrimitive onKeyDown={handleKeyDown} className="w-[400px]">
      <div className="width-100% border border-solid --border rounded-lg">
        <CommandInput
          ref={inputRef}
          value={inputValue}
      ...
      <div className="mt-1 relative">
        {isOpen ? (
          <div 
          className="absolute top-0 z-10 w-full rounded-xl bg-white outline-none animate-in fade-in-0 zoom-in-95"
          >
            <CommandList 
